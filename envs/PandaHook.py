...
class PandaHook(BaseHook):
    ...
    def end_env(self, env_info, logger):
        ...
        # self.success_rate_table[self.test_fricitions.index(envtest_env.envs[0].env.render()_info[0]), self.test_masses.index(env_info[1])] = self.success_count / self.all_count
